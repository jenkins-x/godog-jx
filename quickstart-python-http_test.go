...
type pythonHTTPTest struct {
	common.Test

	Args []string
}

func (o *pythonHTTPTest) aWorkDirectory() error {
	var err error
...
func (o *pythonHTTPTest) runningInThatDirectory(commandLine string) error {
	...
	name := tempDirPrefix + "python-http-" + seed
	o.AppName = name
...
func (o *pythonHTTPTest) thereShouldBeAJenkinsProjectCreate() error {
	fmt.Printf("TODO should be a jenkins project\n")
	return nil
}

func (o *pythonHTTPTest) aRunningApplication() error {
...
func PythonHTTPFeatureContext(s *godog.Suite) {
	o := &pythonHTTPTest{
		Test: common.Test{
