...
type rustHTTPTest struct {
	common.Test

	Args []string
}

func (o *rustHTTPTest) aWorkDirectory() error {
	var err error
...
func (o *rustHTTPTest) runningInThatDirectory(commandLine string) error {
	...
	name := tempDirPrefix + "rust-http-" + seed
	o.AppName = name
...
func (o *rustHTTPTest) thereShouldBeAJenkinsProjectCreate() error {
	fmt.Printf("TODO should be a jenkins project\n")
	return nil
}

func (o *rustHTTPTest) aRunningApplication() error {
...
func RustHTTPFeatureContext(s *godog.Suite) {
	o := &rustHTTPTest{
		Test: common.Test{
