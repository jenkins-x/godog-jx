...
type angularIoQuickstartTest struct {
	common.Test

	Args []string
}

func (o *angularIoQuickstartTest) aWorkDirectory() error {
	var err error
...
func (o *angularIoQuickstartTest) runningInThatDirectory(commandLine string) error {
	...
	name := tempDirPrefix + "angular-io-quickstart-" + seed
	o.AppName = name
...
func (o *angularIoQuickstartTest) thereShouldBeAJenkinsProjectCreate() error {
	fmt.Printf("TODO should be a jenkins project\n")
	return nil
}

func (o *angularIoQuickstartTest) aRunningApplication() error {
	fmt.Printf("TODO should be able to query this using 'jx get app (app name)'\n")
	return nil
}

func (o *angularIoQuickstartTest) executingJxDeleteApp() error {
	appName := tempDirPrefix + "angular-io-quickstart-" + seed
	cmd := "jx"
...
func (o *angularIoQuickstartTest) executingJxDeleteRepo() error {
	appName := tempDirPrefix + "angular-io-quickstart-" + seed
	cmd := "jx"
...
func AngularIoQuickstartFeatureContext(s *godog.Suite) {
	o := &angularIoQuickstartTest{
		Test: common.Test{
